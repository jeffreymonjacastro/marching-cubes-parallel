...
def main():
    ...
    csv_path = 'mpi_row/tiempos_mpi.csv'
    ...
    # Save processed data
    output_csv_path = 'mpi_row/tiempos_mpi_flops.csv'
    if not os.path.exists('mpi_row') and os.path.exists('tiempos_mpi.csv'):
    ...
    plt.title('GFLOPS vs Processes (MPI Row Decomposition)')
    ...
    plot_path = 'mpi_row/gflops_plot.png'
    if not os.path.exists('mpi_row') and os.path.exists('tiempos_mpi.csv'):
